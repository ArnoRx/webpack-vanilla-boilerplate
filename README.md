...
2. `cd webpack-vanilla-boilerplate`
3. `npm install`
4. `npm run start`
5. To build for production: `npm run build`, it will generate folder `build`.
...
```
npm install --save-dev @babel/core @babel/preset-env babel-loader @babel/polyfill core-js@3
```
...
- Add your target browser you want to support in `package.json`. <br>
